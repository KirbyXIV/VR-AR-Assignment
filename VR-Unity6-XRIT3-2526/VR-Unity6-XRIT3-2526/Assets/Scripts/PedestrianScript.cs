...
public class PedestrianScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        wp = GameObject.Find("WP (1)");
        wps.Add(wp.transform);

        wp = GameObject.Find("WP (2)");
        wps.Add(wp.transform);

        wp = GameObject.Find("WP (3)");
        wps.Add(wp.transform);

        wp = GameObject.Find("WP (4)");
        wps.Add(wp.transform);

        wp = GameObject.Find("WP (5)");
        wps.Add(wp.transform);

        wp = GameObject.Find("WP (6)");
        wps.Add(wp.transform);

        wp = GameObject.Find("WP (7)");
        wps.Add(wp.transform);

        wp = GameObject.Find("WP (8)");
        wps.Add(wp.transform);
